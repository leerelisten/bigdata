...
JAR_PATH="${JAR_PATH:-/data/project/flink-transfer-paimon/flink-transfer-paimon-1.0-SNAPSHOT.jar}"
APP_CONFIG="${APP_CONFIG:-/data/project/flink-transfer-paimon/application.yaml}"
