SET mapred.job.name="c_app_course_period_douyinsucai_dashboard#${datebuf}";
USE app;
CREATE EXTERNAL TABLE IF NOT EXISTS app.c_app_course_period_douyinsucai_dashboard
(
    ...
    COMMENT '培训主题数仓-抖音素材期次报表'
    PARTITIONED BY (dt STRING)
    ROW FORMAT DELIMITED
        FIELDS TERMINATED BY '\t'
    STORED AS TEXTFILE
    LOCATION '/dw/app/c_app_course_period_douyinsucai_dashboard';
...
INSERT
    OVERWRITE
    TABLE
    app.c_app_course_period_douyinsucai_dashboard
    PARTITION
(
    dt = '${datebuf}'
)
...
DFS -touchz /dw/app/c_app_course_period_douyinsucai_dashboard/dt=${datebuf}/_SUCCESS;